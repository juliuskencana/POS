			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet light">
							...
							<form class="form-horizontal" role="form" method="get">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control" placeholder="items Name" name="name">
										</div>
						...
						<div class="portlet-title">
							<div class="actions">
								<a href="<?= site_url('items/add'); ?>" class="btn btn-default btn-circle">
								...
								<tbody>
									...
									<?php foreach ($records as $row): ?>
										<tr>
											...
											<td><?= $row->name ?></td>
											<td>
												<a href="<?= site_url('items/edit/' . $row->item_id) ?>">Edit</a> | 
												<a href="<?= site_url('items/delete/' . $row->item_id) ?>">Delete</a>
											</td>
										</tr>
										<?php $i++; ?>
									<?php endforeach ?>
